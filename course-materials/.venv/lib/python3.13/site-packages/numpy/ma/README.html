...
<html lang="en" data-content_root="../../../../../../../" >
  ...
  <head>
    ...
    <title>A guide to masked arrays in NumPy &#8212; Computing Project III</title>
...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'course-materials/.venv/lib/python3.13/site-packages/numpy/ma/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/course-materials/.venv/lib/python3.13/site-packages/numpy/ma/README.rst" target="_blank"
...
<li><p>01/23/2007 : The package has been moved to the SciPy sandbox, and is regularly updated: please check out your SVN version!</p></li>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./course-materials/.venv/lib/python3.13/site-packages/numpy/ma"
        },
